...
namespace zCustodiaUi.pages.register
{
    public class FundsPage
    {
        ...
        public async Task RegisterNewFund()
        {
            ...
            await util.Write(gen.LocatorMatLabel("C�digo ISIN"), "000000000000130", "Write ISIN Code");
            await util.Write(gen.LocatorMatLabel("C�digo ANBID"), "1234567890", "Write ANBID Code");

            await util.Click(gen.LocatorMatLabel("Tipo Fundo"), "Write Type Fund");
            await util.Write(gen.Filter,"Direitos Credit�rios", "Write Type Fund");
            await util.Click(gen.ReceiveTypeOption("Direitos Credit�rios"), "Click on UF option");
            ...
            await util.Write(gen.LocatorMatLabel("Prazo de Recep��o da Chave da NFe"), "5", "Write NFe Key Receipt Deadline");
            
            await util.Write(gen.LocatorMatLabel("Prazo Recep��o do Lastro"), "5", "Write Deadline Reception Ballast");
            ...
            await util.Write(gen.LocatorMatLabel("Num. Sequencial Att Termo Cess�o"), "1001", "Write Sequence Number Term Cession");
            await util.Write(gen.LocatorMatLabel("Num. Sequencial Att Termo Recompra"), "1002", "Write Sequence Number Term Repurchase");
            await util.Write(gen.LocatorMatLabel("Qtd. Dias Retroagir Importa��o PL"), "10", "Write Quantity Days Import PL");
            await util.Write(gen.LocatorMatLabel("Conv�nio"), "12345", "Write Agreement");
            await util.Write(gen.LocatorMatLabel("Valor M�ximo para o Rob� Assinatura"), "10000", "Write Max Value To Assign Robot");
            ...
            await util.Write(gen.LocatorMatLabel("C�digo Carteira"), "001", "Write Wallet Code");
            ...
            await util.Write(gen.Filter, "Por receb�vel", "Write Aquisition Select");
            await util.Click(gen.ReceiveTypeOption("Por receb�vel"), "Click on UF option");
            ...
            //Liquidation 
            await util.ScrollToElementAndMaintainPosition(gen.TabAllForms("Liquida��o"), "Scroll to belt to change form");
            await Task.Delay(500);
            await util.ClickMatTabAsync(gen.TabAllForms("Liquida��o"), "Click belt to change form");

            await util.Write(gen.LocatorMatLabel("Percentual M�ximo Reembolso de Despesas"), "10", "Set max percent of reimbursement");
            ...
            await util.Write(gen.LocatorMatLabel("N�mero Ag�ncia"), "1", "Write Number Agency");
            await util.Write(gen.LocatorMatLabel("Conta Corrente"), "46677", "Write Number account");
            await util.Write(gen.LocatorMatLabel("D�gito"), "3", "Write Code account");
            ...
            await util.Write(gen.LocatorMatLabel("Descri��o"), "Conta para fundo de teste", "fill description of account test");
            ...
            await util.Write(gen.LocatorMatLabel("SlackWebhook Opera��es:"), "WebHook Test", "Insert name of operations webhook");            
            await util.Write(gen.LocatorMatLabel("Nome Canal Opera��es:"), "Channel Test", "Insert Name Of Channel Operations");
            await util.Write(gen.LocatorMatLabel("ID Canal Opera��es:"), "01", "Insert ID of Channel Operations");
            ...
            //File Validation
            await util.ClickMatTabAsync(gen.TabAllForms("Valida��o Arquivo"), "Click belt to change form");
            await Task.Delay(500);
            ...
            await util.Click(gen.RightArrow, "Click on  Arrow to expand group tab");
            await util.ClickMatTabAsync(gen.TabAllForms("Prestadores de Servi�os"), "Click belt to change form");
            await util.Click(gen.ButtonNew, "Click on button new to insert a new Slack Channel");
            await Task.Delay(500);
        ...
        public async Task UpdateFund()
        {
            ...
            //Make changes
            await util.Write(gen.LocatorMatLabel("C�digo ISIN"), "000000000000001", "Edit Code isin");
