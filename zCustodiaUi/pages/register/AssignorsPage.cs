...
namespace zCustodiaUi.pages.register
{
        ...
        private static readonly List<string> Cnpjs = new List<string>
    {
        ...
        public async Task CRUD_Assignors()
        {
            ...
            //General Data
            await util.Click(gen.Locator("Fundo"), "Click on fund select");
            ...
            await util.Write(gen.Locator("Nome"), nameAssignor, "Insert Name of Assignor to be Registered");
            await util.Write(gen.Locator("CNPJ"), cnpjAssignor, "Insert CNPJ of Assignor to be Registered");
            await util.Write(gen.Locator("Inscrição Estadual"), "123456789", "Insert State Registration of Assignor to be Registered");
            await util.Write(gen.Locator("Inscrição Municipal"), "987654321", "Insert Municipal Registration of Assignor to be Registered");
            await Task.Delay(150);

            await util.Click(gen.Locator("Ramo de Atividade"), "Click on Activity Select");
            ...
            await util.Click(gen.Locator("Porte"), "COMÉRCIO on Port Select");
            ...
            await Task.Delay(150);
            await util.Write(gen.Locator("Email"), "teste@email.com.br", "Insert Email to be registered");

            await util.Click(gen.Locator("Tipo de Sociedade"), "Click on Type of Society Select");
            ...
            await Task.Delay(150);
            await util.Click(gen.Locator("Classificação de Risco"), "Click on Risk Classification Select");
            ...
            await util.Write(gen.Locator("Faturamento Anual"), "50000000", "Insert Annual Billing to be Registered");
            await page.Keyboard.PressAsync("Space");
            await util.Click(el.Authorization(true), "Click on Authorization Radio Button to be Registered");

            //Location
            await util.ScrollToElementAndMaintainPosition(gen.Locator("CEP"), "Scroll to CEP");

            await util.Write(gen.Locator("CEP"), "01310-000", "Insert Postal Code to be Registered");
            await util.Write(gen.Locator("Endereço"), "Avenida Paulista", "Insert Address to be Registered");
            await util.Write(gen.Locator("Número"), "1000", "Insert Number to be Registered");
            await util.Write(gen.Locator("Complemento"), "10º Andar", "Insert Complement to be Registered");
            await util.Write(gen.Locator("Bairro"), "Bela Vista", "Insert Neighborhood to be Registered");
            await util.Write(gen.Locator("Cidade"), "São Paulo", "Insert City to be Registered");

            await util.Click(gen.Locator("UF"), "Click on UF Select");
            ...
            //Tax Data 
            await util.Write(gen.Locator("Conglomerado Econômico"), "Conglomerado Teste Zitec", "Insert Economic Conglomerate to be Registered");
            await util.Write(gen.Locator("Número mínimo de assinaturas para aprovação"), "80", "Insert Assignor Percentage to be Approved to be Registered");
            await util.Write(gen.Locator("Limite de Crédito"), "1000000", "Insert Credit Limit to be Registered");
            await page.Keyboard.PressAsync("Space");
            await Task.Delay(150);

            await util.Click(gen.Locator("Coobrigação"), "Click on Is Coobrigation Select");
            ...
            await Task.Delay(150);
            await util.Click(gen.Locator("Banco"), "Insert Bank Number to be Registered");
            ...
            await util.Write(gen.Locator("Número Agência"), "1", "Insert Agency Number to be Registered");
            await util.Write(gen.Locator("Conta Corrente"), "46677", "Insert Account Number to be Registered");
            await util.Write("(" + gen.Locator("Dígito") + ")[2]", "3", "Insert Account Digit to be Registered");
            await util.Write(gen.Locator("Descrição"), "Teste", "Click on Account Type Select");
            ...
            await Task.Delay(600);
            await util.Click(gen.ButtonNew, "Click in New to insert a New Account");
            await util.Write(gen.Locator("Nome"), "Representante Teste Zitec", "Insert Name of Representative to be Registered");
            await util.Write(gen.Locator("E-mail"), "email@representantetestZitec.ai", "Insert E-mail of Representative to be Registered");
            await util.Write(gen.Locator("CPF"), "40956114806", "Insert CPF of Representative to be Registered");
            await util.Write(gen.Locator("Telefone"), "11934125767", "Insert Telephone of Representative to be Registered");
            ...
            await Task.Delay(500);
            await util.Click(gen.Locator("Fundo"), "Click on Filter Select to filter Assignor to be consulted");
            ...
            await util.Write(gen.Locator("Nome Cedente"), nameAssignor, "Insert Name Assignor to be consulted");
            await util.Write(gen.Locator("CNPJ"), cnpjAssignor, "Insert CNPJ Assignor to be consulted");
            ...
            await Task.Delay(150);
            await util.Write(gen.Locator("Nome"), "Cedente Teste Zitec EDITADO", "Insert Name EDITED of Assignor to be Registered");
